...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--is_slippery', type=str2bool, default=False, help="If True, environment is slippery.")
    parser.add_argument('--reward_shaping', type=str2bool, default=False, help="If True, reward shaping is applied.")
